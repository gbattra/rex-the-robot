...
namespace SensorToolkit.PlayMaker
{
    ...
    [Tooltip("Sets a steering rigs target direction which it should face. Assign it a GameObject or a Vector3 position to face towards. If you want thw Steering rig to stop strafing then assign both the direction and gameobject parameters to None.")]
