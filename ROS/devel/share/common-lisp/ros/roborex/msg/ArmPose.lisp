...
(cl:defclass <ArmPose> (roslisp-msg-protocol:ros-message)
  ((world_joint
   ...
   (gripper_offset_joint
    :reader gripper_offset_joint
    :initarg :gripper_offset_joint
    :type roborex-msg:JointState
    :initform (cl:make-instance 'roborex-msg:JointState))
   (right_gripper_joint
...
(cl:ensure-generic-function 'gripper_offset_joint-val :lambda-list '(m))
(cl:defmethod gripper_offset_joint-val ((m <ArmPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roborex-msg:gripper_offset_joint-val is deprecated.  Use roborex-msg:gripper_offset_joint instead.")
  (gripper_offset_joint m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ArmPose>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'gripper_offset_joint) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'right_gripper_joint) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'left_gripper_joint) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmPose>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'gripper_offset_joint) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'right_gripper_joint) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'left_gripper_joint) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ArmPose>)))
  ...
  "a5e1af2ff95ce9860148ff20620f2dd0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ArmPose)))
  "Returns md5sum for a message object of type 'ArmPose"
  "a5e1af2ff95ce9860148ff20620f2dd0")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ArmPose>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'gripper_offset_joint))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'right_gripper_joint))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'left_gripper_joint))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ArmPose>))
  ...
  (cl:list 'ArmPose
    ...
    (cl:cons ':gripper_offset_joint (gripper_offset_joint msg))
